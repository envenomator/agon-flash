...
#define FILENAME	"firmware103rc1.bin"
#define CRC103RC1	0xC7EB8372
...
int main(int argc, char * argv[]) {
	...
	printf("This utility will upgrade an existing 1.00/1.01 firmware to 1.03rc1\r\n\r\n");
