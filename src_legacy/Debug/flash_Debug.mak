...
#
# ZDS II Make File - flash project, Debug configuration
#
...
# project directory
PRJDIR = C:\source\Agon\Programs\flash\src_legacy
PRJDIR_ESCSPACE = C:\source\Agon\Programs\flash\src_legacy

# intermediate files directory
WORKDIR = C:\source\Agon\Programs\flash\src_legacy\Debug
WORKDIR_ESCSPACE = C:\source\Agon\Programs\flash\src_legacy\Debug

# output files directory
OUTDIR = C:\source\Agon\Programs\flash\src_legacy\Debug\
OUTDIR_ESCSPACE = C:\source\Agon\Programs\flash\src_legacy\Debug\
...
LDFLAGS = @..\flash.linkcmd
build: flash relist

buildall: clean flash relist

relink: deltarget flash

deltarget: 
	@if exist "$(WORKDIR)\flash.lod"  \
            $(RM) "$(WORKDIR)\flash.lod"
	@if exist "$(WORKDIR)\flash.hex"  \
            $(RM) "$(WORKDIR)\flash.hex"
	@if exist "$(WORKDIR)\flash.map"  \
            $(RM) "$(WORKDIR)\flash.map"
...
clean: 
	...
	@if exist "$(WORKDIR)\flash.obj"  \
            $(RM) "$(WORKDIR)\flash.obj"
	@if exist "$(WORKDIR)\flash.lis"  \
            $(RM) "$(WORKDIR)\flash.lis"
	@if exist "$(WORKDIR)\flash.lst"  \
            $(RM) "$(WORKDIR)\flash.lst"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\flash.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\Debug\agontimer.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\Programs\flash\src_legacy\Debug\flash.map" \
            C:\source\Agon\Programs\flash\src_legacy\Debug\crc32.src
...
$(WORKDIR_ESCSPACE)\flash.obj :  \
            $(PRJDIR_ESCSPACE)\flash.asm
	 $(AS) $(ASFLAGS) "$(PRJDIR)\flash.asm"
